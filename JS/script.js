const audioElement = new Audio("../mp3/Zack Knight/Angel.mp3");

// let songs = [
//     {artist: "Zack Knight", songName: "Angel", filePath: "../mp3/Zack Knight/Angel.mp3", coverPath: "../cover/angel500x500.jpg"},
//     {artist: "Zack Knight", songName: "Bom-Diggy", filePath: "../mp3/Zack Knight/Bom Diggy.mp3", coverPath: "../cover/Bom-Diggy-500x500.jpg"},
//     {artist: "Zack Knight", songName: "Dheere Dheere Se", filePath: "../mp3/Zack Knight/Dheere.mp3", coverPath: "../cover/Dheere-500x500.jpg"},
//     {artist: "Zack Knight", songName: "Dum Dee Dum", filePath: "../mp3/Zack Knight/Dum Dee Dum.mp3", coverPath: "../cover/dum-dee-dee-dum.jpg"},
//     {artist: "Zack Knight", songName: "Enemy", filePath: "../mp3/Zack Knight/Enemy.mp3", coverPath: "../cover/enemy-1200x1200bf-60.jpg"},
//     {artist: "Zack Knight", songName: "General", filePath: "../mp3/Zack Knight/General.mp3", coverPath: "../cover/general500x500.jpg"},
//     {artist: "Zack Knight", songName: "Gotta Go", filePath: "../mp3/Zack Knight/Gotta Go.mp3", coverPath: "../cover/gotta_go_500x500.jpg"},
//     {artist: "Zack Knight", songName: "Nakhre", filePath: "../mp3/Zack Knight/Nakhre.mp3", coverPath: "../cover/nakhre.jpg"},
//     {artist: "Zack Knight", songName: "Queen", filePath: "../mp3/Zack Knight/Queen.mp3", coverPath: "../cover/queen.jpg"},
//     {artist: "Zack Knight", songName: "The Zack Knight Mashup",filePath: "../mp3/Zack Knight/The_Zack_Knight_Mashup.mp3", coverPath: "../cover/mashup.jpg"},
//     {artist: "Zack Knight", songName: "Thumka", filePath: "../mp3/Zack Knight/Thumka.mp3", coverPath: "../cover/thumka.jpg"},
//     {artist: "Zack Knight", songName: "Tumhari Jagga", filePath: "../mp3/Zack Knight/Tumhari Jagga.mp3", coverPath: "../cover/tumhari jagga 1200x1200bf-60.jpg"},
//     {artist: "Zack Knight", songName: "Women", filePath: "../mp3/Zack Knight/Women.mp3", coverPath: "../cover/women 1200x1200bf-60.jpg"},

//     {artist: "Enrique Iglesias", songName: "Bailando", filePath: "../mp3/Enrique Iglesias/Bailando.mp3", coverPath: "../cover/enrique/bailando.jpg"},
//     {artist: "Enrique Iglesias", songName: "Dirty Dancer", filePath: "../mp3/Enrique Iglesias/Dirty Dancer.mp3", coverPath: "../cover/enrique/Dirty Dancer.jpg"},
//     {artist: "Enrique Iglesias", songName: "Mouth 2 Mouth", filePath: "../mp3/Enrique Iglesias/Mouth 2 Mouth.mp3", coverPath: "../cover/enrique/Mouth2Mouth.jpg"},
//     {artist: "Enrique Iglesias", songName: "Move To Miami", filePath: "../mp3/Enrique Iglesias/Move To Miami.mp3", coverPath: "../cover/enrique/Move_to_Miami.jpg"},
//     {artist: "Enrique Iglesias", songName: "Tonight I'm Lovin You", filePath: "../mp3/Enrique Iglesias/Tonight.mp3", coverPath: "../cover/enrique/tonight.jpg"},

//     {artist: "Justin Bieber", songName: "2U", filePath: "../mp3/Justin Bieber/2U.mp3", coverPath: "../cover/justin/2U.jpg"},
//     {artist: "Justin Bieber", songName: "Baby", filePath: "../mp3/Justin Bieber/baby.mp3", coverPath: "../cover/justin/Baby.jpg"},
//     {artist: "Justin Bieber", songName: "Boyfriend", filePath: "../mp3/Justin Bieber/Boyfriend.mp3", coverPath: "../cover/justin/boyfriend.jpg"},
//     {artist: "Justin Bieber", songName: "Despacito", filePath: "../mp3/Justin Bieber/Despacito.mp3", coverPath: "../cover/justin/despacito.jpg"},
//     {artist: "Justin Bieber", songName: "I'm The One", filePath: "../mp3/Justin Bieber/I'm the One.mp3", coverPath: "../cover/justin/ImTheOne.jpg"},
//     {artist: "Justin Bieber", songName: "Let Me Love You", filePath: "../mp3/Justin Bieber/Let Me Love You.mp3", coverPath: "../cover/justin/Let me love you.jpg"},
//     {artist: "Justin Bieber", songName: "Sorry", filePath: "../mp3/Justin Bieber/Sorry.mp3", coverPath: "../cover/justin/sorry.jpg"},
//     {artist: "Justin Bieber", songName: "What Do You Mean", filePath: "../mp3/Justin Bieber/What Do You Mean.mp3", coverPath: "../cover/justin/what do you mean.jpg"},
// ]
...
let songs = [
    ...
    {id:"13", songName: `<h5>Angel<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Angel.mp3", coverPath: "../cover/zack/angel500x500.jpg"},
    {id:"14", songName: `<h5>Bom Diggy<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Bom Diggy.mp3", coverPath: "../cover/zack/Bom-Diggy-500x500.jpg"},
    {id:"15", songName: `<h5>Dheere Dheere Se<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Dheere.mp3", coverPath: "../cover/zack/Dheere-500x500.jpg"},
    {id:"16", songName: `<h5>Dum Dee Dum<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Dum Dee Dum.mp3", coverPath: "../cover/zack/dum-dee-dee-dum.jpg"},
    {id:"17", songName: `<h5>Enemy<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Enemy.mp3", coverPath: "../cover/zack/enemy-1200x1200bf-60.jpg"},
    {id:"18", songName: `<h5>General<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/General.mp3", coverPath: "../cover/zack/general500x500.jpg"},
    {id:"19", songName: `<h5>Gotta Go<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Gotta Go.mp3", coverPath: "../cover/zack/gotta_go_500x500.jpg"},
    {id:"20", songName: `<h5>Nakhre<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Nakhre.mp3", coverPath: "../cover/zack/nakhre.jpg"},
    {id:"21", songName: `<h5>Queen<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Queen.mp3", coverPath: "../cover/zack/queen.jpg"},
    {id:"22", songName: `<h5>The Zack Knight Mashup<br><div class="subtitle">Zack Knight</div></h5>`,filePath: "../mp3/Zack Knight/The_Zack_Knight_Mashup.mp3", coverPath: "../cover/zack/mashup.jpg"},
    {id:"23", songName: `<h5>Thumka<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Thumka.mp3", coverPath: "../cover/zack/thumka.jpg"},
    {id:"24", songName: `<h5>Tumhari Jagga<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Tumhari Jagga.mp3", coverPath: "../cover/zack/tumhari jagga 1200x1200bf-60.jpg"},
    {id:"25", songName: `<h5>Women<br><div class="subtitle">Zack Knight</div></h5>`, filePath: "../mp3/Zack Knight/Women.mp3", coverPath: "../cover/zack/women 1200x1200bf-60.jpg"},
]
...
input.addEventListener("keyup", () => {
    ...
    for (let index=0; index<items.length; index++) {
        ...
        // console.log(textValue.toUpperCase().indexOf(inputValue));
...
Array.from(document.getElementsByClassName("songItem")).forEach((e, i) => {
    ...
    // Need to check
    // e.getElementsByClassName("subtitle").innerHTML = songs[i].artist;
    // console.log(e.querySelectorAll("li h5 div"));
})
...
// let masterPlaySubtitle = document.getElementsByClassName("masterPlaySubtitle")[0];
// console.log(masterPlaySubtitle);
...
Array.from(document.getElementsByClassName("playSong")).forEach((e) => {
    e.addEventListener("click", (el) => {
        if (audioElement.paused || audioElement.currentTime === 0) {
            ...
            // Not working (was trying to change the subtitle of song)
            // console.log(masterPlaySubtitle[0].innerHTML);
            // masterPlaySubtitle[0].innerHTML = songs[index].artist;


            // Alternate way to change the inner text of songName (though it takes around 10 lines and I've already done it in 1 line)

            // let songDetails = songs.filter((each) => {
            ...
            // then make the current song as hovered to show that thie clicked song is playing 
